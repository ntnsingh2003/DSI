...
function EmptyState() {
  return (
    <div className="no-data-placeholder">
      ...
      <p>Upload an Excel or CSV file on the Chat page. Qwen-7B will analyze it and generate insights, recommendations, and charts here.</p>
      <Link to="/chat">
...
export default function Reports() {
  ...
  const handleDownloadReportText = () => {
    ...
    const content = [
      ...
      `Generated by Qwen-7B from ${uploadedData.rowCount.toLocaleString()} rows and ${uploadedData.columns.length} columns`,
      `=========================================`,
      ``,
      `EXECUTIVE SUMMARY:`,
      ...
      <main className="main-content">
        ...
        <div className="data-banner">
          ...
          <span className="data-banner-meta">
            · {uploadedData.rowCount.toLocaleString()} rows · Qwen-7B
          </span>
        ...
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">
              Generated by Qwen-7B from {uploadedData.rowCount.toLocaleString()} rows · {uploadedData.columns.length} columns
            </p>
          </div>
