...
function EmptyState() {
  return (
    <div className="no-data-placeholder">
      ...
      <p>Upload an Excel or CSV file on the Chat page. DeepSeek-R1-8B will analyze it and generate insights, recommendations, and charts here.</p>
      <Link to="/chat">
...
export default function Reports() {
  ...
  const handleDownloadReportText = () => {
    ...
    const content = [
      ...
      `Generated by ${uploadedData.model || 'DeepSeek-R1-8B'} from ${uploadedData.rowCount.toLocaleString()} rows and ${uploadedData.columns.length} columns`,
      `=========================================`,
      ``,
      `EXECUTIVE SUMMARY:`,
      ...
      <main className="main-content">
        ...
        <div className="data-banner">
          ...
          <span className="data-banner-meta">
            · {uploadedData.rowCount.toLocaleString()} rows · {uploadedData.model || 'DeepSeek-R1-8B'}
          </span>
        ...
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">
              Generated by {uploadedData.model || 'DeepSeek-R1-8B'} from {uploadedData.rowCount.toLocaleString()} rows · {uploadedData.columns.length} columns
            </p>
          </div>
        ...
        <div className="report-hero animate-fadeInUp">
          <div className="report-meta">
            ...
            <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>
              File: {uploadedData.fileName} · {uploadedData.rowCount.toLocaleString()} rows · {uploadedData.model || 'DeepSeek-R1-8B'}
            </span>
          </div>
        ...
        {uploadedData.insights?.length > 0 && (
          <>
            <div style={{ fontSize: 13, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-muted)', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              Key Insights from {uploadedData.model || 'DeepSeek-R1-8B'}
            </div>
        ...
        {uploadedData.recommendations?.length > 0 && (
          <div className="report-section animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <div className="report-section-title">
              ...
              {uploadedData.model || 'DeepSeek-R1-8B'} Recommendations
            </div>
