...
import {
  ...
  BarChart2, Target, FileSpreadsheet, MessageSquare, AlertTriangle
} from 'lucide-react';
...
function EmptyState() {
  return (
    <div className="no-data-placeholder">
      ...
      <p>Upload an Excel or CSV file on the Dashboard. Google Gemini 2.5 Flash will analyze it and generate insights, recommendations, and charts here.</p>
      <Link to="/chat">
    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        ...
        {uploadedData.insights?.length > 0 && (
          <>
            <div style={{ fontSize: 13, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-muted)', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              Key Insights from {uploadedData.model || 'Gemini-2.5-Flash'}
            </div>
        ...
        {uploadedData.recommendations?.length > 0 && (
          <div className="report-section animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <div className="report-section-title">
              ...
              {uploadedData.model || 'Gemini-2.5-Flash'} Recommendations
            </div>
        ...
        {uploadedData.anomalies?.length > 0 && (
          <div className="report-section animate-fadeInUp" style={{ animationDelay: '0.35s' }}>
            <div className="report-section-title">
              <AlertTriangle size={18} color="#ef4444" />
              Gemini Data Anomalies & Outliers
            </div>
